...
@Component({
  selector: 'app-c13prodinputoutput',
  templateUrl: './c13prodinputoutput.component.html',
  styleUrls: ['./c13prodinputoutput.component.css']
})
export class C13prodinputoutputComponent implements OnInit {
