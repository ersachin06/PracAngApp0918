...
@Component({
  selector: 'app-c3-directive',
  templateUrl: './c3-directive.component.html',
  styleUrls: ['./c3-directive.component.css']
})
export class C3DirectiveComponent implements OnInit {
 
  users:string[]=["rohan","sohan","mohan"];
  categories:any[]=[
    {id:1,name:"laptop",desc:"description",img:"l1.jpg"},
    {id:1,name:"mobile",desc:"description",img:"m1.jpg"},
    {id:1,name:"shoes",desc:"description",img:"s1.jpg"},
    {id:1,name:"clothes",desc:"description",img:"c1.jpg"}
