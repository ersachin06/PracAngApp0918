...
@Component({
  selector: 'app-c14prodeventobject',
  templateUrl: './c14prodeventobject.component.html',
  styleUrls: ['./c14prodeventobject.component.css']
})
export class C14prodeventobjectComponent implements OnInit {
  ...
  ratingStatus(prodinfo)
  {
    this.currentRating=prodinfo.prating11;
    this.feedback=prodinfo.status;
    //alert(prodinfo.prating11+" "+prodinfo.status);
