...
@Component({
  selector: 'app-c17prod-pass-arg',
  templateUrl: './c17prod-pass-arg.component.html',
  styleUrls: ['./c17prod-pass-arg.component.css']
})
export class C17prodPassArgComponent implements OnInit {
  products:any[]=[
