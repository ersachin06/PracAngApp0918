...
@Component({
  selector: 'app-c11prod-passing-obj-to-child',
  templateUrl: './c11prod-passing-obj-to-child.component.html',
  styleUrls: ['./c11prod-passing-obj-to-child.component.css']
})
export class C11prodPassingObjToChildComponent implements OnInit {
