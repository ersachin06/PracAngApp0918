...
export class S2sumitdirComponent implements OnInit {
  ...
  products:any[]=[
    ...
    {pid:5,catid:3,name:'nike',img:'s1.jpg',desc:'description',price:45000,qty:300,rating:5},
    {pid:6,catid:3,name:'woodland',img:'s2.jpg',desc:'description',price:65000,qty:400,rating:4},
    {pid:7,catid:4,name:'wrangler',img:'c1.jpg',desc:'description',price:75000,qty:450,rating:3},
    {pid:8,catid:4,name:'spykar',img:'c2.jpg',desc:'description',price:85000,qty:500,rating:2}
  ];
  products2:any[]=[
