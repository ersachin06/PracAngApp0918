...
@Component({
  selector: 'app-tempprod',
  templateUrl: './tempprod.component.html',
  styleUrls: ['./tempprod.component.css']
})
export class TempprodComponent implements OnInit {

  constructor() { }
  cat:any[]=[
    {catid:1,name:"laptop",img:"l1.jpg",desc:"description"}
  ];
  products:any[]=[
